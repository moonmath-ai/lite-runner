...
GEMMA_DIR = snapshot_download("google/gemma-3-12b-it-qat-q4_0-unquantized", local_files_only=True)
...
runner = Runner(
    ...
    params=[
        ...
        Param("height", type="int", default=1024, help="Video height (divisible by 64)"),
